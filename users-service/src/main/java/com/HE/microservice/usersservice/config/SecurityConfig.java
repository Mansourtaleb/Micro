package com.HE.microservice.usersservice.config;
...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/users/public/**", "/actuator/**").permitAll()
    ...
    JwtAuthenticationConverter keycloakAuthoritiesConverter() {
        ...
        // Retourner exactement Collection<GrantedAuthority> (pas <? extends ...>)
